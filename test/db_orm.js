...
describe('db_orm', function() {
  describe('config', function() {
    it('should get a connect string', function() {
      ...
      connect_string.should.eql('sqlite://bombay.db');
    });

    it('should set the db name', function() {
      bombay_db.setDBName('bombay_test.db');
      var connect_string = bombay_db.getConnect();
  ...
  describe('access', function() {
    describe('Band', function() {
      ...
      it('should create a band row', function(done) {
        bombay_db.connect(function(db_model) {
          db_model.Band.create([{name: 'Plover'}], function(err, bands) {
      ...
      it('should get the band', function(done) {
        bombay_db.connect(function(db_model) {
          db_model.Band.get(last_band_id, function(err, band) {
            should.not.exist(err);
            should.exist(band);
    ...
    describe('Person', function() {
      ...
      it('should get the person', function(done) {
        bombay_db.connect(function(db_model) {
          db_model.Person.get(last_person_id, function(err, person) {
            should.not.exist(err);
            should.exist(person);
    ...
    describe('Artist', function() {
      ...
      it('should create a artist row', function(done) {
        bombay_db.connect(function(db_model) {
          db_model.Artist.create([{name: 'Plover'}], function(err, artists) {
            should.not.exist(err);
      ...
      it('should get the artist', function(done) {
        bombay_db.connect(function(db_model) {
          db_model.Artist.get(last_artist_id, function(err, artist) {
            should.not.exist(err);
            should.exist(artist);
    ...
    describe('Song', function() {
      ...
      it('should get the song', function(done) {
        bombay_db.connect(function(db_model) {
          db_model.Song.get(last_song_id, function(err, song) {
            should.not.exist(err);
            should.exist(song);
    ...
    describe('BandMember', function() {
      ...
      it('should get the band_member', function(done) {
        bombay_db.connect(function(db_model) {
          db_model.BandMember.get(last_band_member_id, function(err, band_member) {
            should.not.exist(err);
    ...
    describe('BandSong', function() {
      ...
      it('should get the band_song', function(done) {
        bombay_db.connect(function(db_model) {
          db_model.BandSong.get(last_band_song_id, function(err, band_song) {
            should.not.exist(err);
  ...
  describe('Ratings', function() {
    ...
    it('should get the ratings for Plover', function(done) {
      bombay_db.connect(function(db_model) {
        db_model.Band.find({name: 'Plover'}, function(err, bands) {
          should.not.exist(err);
          should.exist(bands);
          bands.length.should.eql(1);
  ...
  describe('Requests', function() {
    ...
    it('should get the requests for jguitar', function(done) {
      bombay_db.connect(function(db_model) {
        db_model.Request.find({person_id: persons_by_name['jguitar']}, function(err, requests) {
          should.not.exist(err);
          should.exist(requests);
    ...
    it('should get the requests for Plover', function(done) {
      bombay_db.connect(function(db_model) {
        db_model.Request.find({band_id: bands_by_name['Plover']}, function(err, requests) {
          should.not.exist(err);
          should.exist(requests);
