...
orm.connect(exports.getConnect() + '?strdates=true', function(err, db) {
  ...
  RehearsalRunThrough = db.define('rehearsal_run_through', {
    sequence: {type: 'number'}
  }, {
    cache: false,
  });
  RehearsalRunThrough.hasOne('rehearsal_plan', RehearsalPlan, {reverse: 'rehearsalPlan'});
  RehearsalRunThrough.hasOne('band_song', RehearsalPlan, {reverse: 'bandSong'});
  columns.RehearsalRunThrough = ['id', 'rehearsal_plan_id', 'sequence', 'band_song_id'];
  exports.RehearsalRunThrough = RehearsalRunThrough;

  RehearsalLearning = db.define('rehearsal_learning', {
    sequence: Number
  }, {
    cache: false,
  });
  RehearsalLearning.hasOne('rehearsal_plan', RehearsalPlan, {reverse: 'rehearsalPlan'});
  RehearsalLearning.hasOne('band_song', RehearsalPlan, {reverse: 'bandSong'});
  columns.RehearsalLearning = ['id', 'rehearsal_plan_id', 'sequence', 'band_song_id'];
  exports.RehearsalLearning = RehearsalLearning;
